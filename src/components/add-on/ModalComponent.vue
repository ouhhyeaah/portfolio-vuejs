<template>
  <div id="modal">
    <div class="flex flex-col items-center justify-center p-3 min-h-full">
      <h1
          class="my-4 text-3xl text-center font-medium tracking-wider text-gray-700"
      >
        {{ title }}
      </h1>
      <button
          @click="onToggle"
          class="bg-gray-500 border border-gray-500 px-5 py-2 text-sm shadow-sm font-medium tracking-wider text-white rounded-md hover:shadow-lg hover:bg-gray-600"
      >
        Open
      </button>
    </div>
